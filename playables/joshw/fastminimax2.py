...
from playables.joshw.FastGameState2 import FastGameState2, FastMove


class FastMinimax2(Playable):
    ...
    def move(self, game_state: GameState) -> int:
        ...
        for move in game_state.open_columns():
            child_game = FastGameState2.from_gamestate(game_state)
    ...
    @classmethod
    def eval(cls, game_state: FastGameState2, depth: int, 
    ...
    @classmethod
    def _max_eval(cls, depth: int, game_state: FastGameState2, alpha: float,
                  beta: float) -> float:
        """
    ...
    @classmethod
    def _min_eval(cls, depth: int, game_state: FastGameState2, alpha: float,
                  beta: float) -> float:
        """
    ...
    @classmethod
    def open_columns_sorted(cls, game_state: FastGameState2,
